	...
	*/
	...
	typedef struct 
	{
		...
		sLoRa_OTAA OTAA =
		{
			...
			.AppEUI   = {  0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x00, 0xA4, 0xDE  },    //  TTN Ideetron Application EUI, change this to your own APP EUI code
      .AppKey   = { 0x35, 0x19, 0x7B, 0xE4, 0x9B, 0x85, 0x73, 0x50, 0x9F, 0x1F, 0xB5, 0xA0, 0x00, 0x4D, 0xF7, 0xAD },
			.DevNonce = {0},
			.AppNonce = {0},
			.NetID    = {0},
			.OTAAdone = false,
